...
def main():
    ...
    while 1:
        ...
        for square in snake_body:
            if snake_body.index(square) == len(snake_body)-1:
                pygame.draw.rect(WIN ,(255, 0, 0), (square[0],square[1],20,20))
            else:
                pygame.draw.rect(WIN ,(255, 255, 0), (square[0],square[1],20,20))
        ...
        pygame.draw.rect(WIN ,(138,43,226),(fruit_pos[0],fruit_pos[1],20,20))
        ...
        if pygame.Rect(snake_pos[0],snake_pos[1],20,20).colliderect(pygame.Rect(fruit_pos[0],fruit_pos[1],20,20)):
            fruit_spawn=True
            score += 5
        else:
            snake_body.pop(0)
